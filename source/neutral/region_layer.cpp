...
void delta_region_class(float *output, float *delta, int index, int class_id, int classes, tree *hier, float scale, int stride, float *avg_cat)
{
    int i, n;
    if(hier){
        float pred = 1;
        ...
        if(l.softmax_tree){
            ...
            for(t = 0; t < 30; ++t){
                ...
                if(truth.x > 100000 && truth.y > 100000){
                    ...
                    delta_region_class(l.output, l.delta, class_index, class_id, l.classes, l.softmax_tree, l.class_scale, l.w*l.h, &avg_cat);
